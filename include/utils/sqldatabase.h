...
public:
    ...
    // 初始化数据库连接
    bool initialize(const std::string& main_db_path = "/home/ubuntu/mnt/ems_project/storage_system.db",
...
private:
    ...
    bool bindValue(sqlite3_stmt* stmt, int index, const DeviceDataItem& item);
